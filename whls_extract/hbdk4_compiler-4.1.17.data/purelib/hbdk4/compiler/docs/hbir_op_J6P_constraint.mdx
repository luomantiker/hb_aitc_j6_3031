# HBIR Operator Constraint in target J6P
...
The type of input must be F16, and the type of output must be f16 or bool or i16(argmax).
...
<table>
    ...
    <tr>
        <td>lhs</td>
        <td>
            <li>Type: int8, int16, f16, int32, if type is int32, this hbir.add op must be fusible to a Conv op</li>
            <li>Shape: [*]</li>
        </td>
    </tr>
    <tr>
...
<table>
  ...
  <tr>
      <td>lhs</td>
      <td>
          <li>Type: int8, int16, f16, bool8</li>
          <li>Shape: [*]</li>
      </td>
  </tr>
  <tr>
...
<table>
  ...
  <tr>
      ...
      <td>
          ...
          <li>The H, W coordinates of each channel must be the same</li>
      </td>
  </tr>
  <tr>
      <td>output</td>
...
The type of inputs must be F16, and the type of outputs must be f16 or bool or i16(argmax).
...
<table>
    ...
    <tr>
        ...
        <td>
            <li>Shape: [KH,KW]</li>
            <li>Dim: KH, KW ∈ [1, 256], avgPool: KH*KW*bitWidth/8 <= 32768, maxPool: KH*KW <= 32768</li>
        </td>
    </tr>
    <tr>
        <td>stride</td>
        <td>
            <li>Shape: [SH,SW]</li>
            <li>Dim: SH, SW ∈ [1, 256]</li>
        </td>
    </tr>
    <tr>
        <td>pad</td>
        <td>
            <li>Shape: [PH_BEGIN,PW_BEGIN,PH_END,PW_END]</li>
            <li>PH_BEGIN,PW_BEGIN,PH_END,PW_END ∈ [-4, 256]</li>
        </td>
    </tr>
</table>
