...
def structured_hoist_redundant_vector_transfers(transformed, target, *, verify_non_zero_trip=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(HoistRedundantVectorTransfersOp(transformed=transformed, target=target, verify_non_zero_trip=verify_non_zero_trip, loc=loc, ip=ip))
