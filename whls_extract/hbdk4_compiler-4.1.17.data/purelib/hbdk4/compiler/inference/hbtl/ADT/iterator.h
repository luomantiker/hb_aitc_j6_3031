...
/// forked from llvm/ADT/iterator.h
#pragma once
...
HBTL_NAMESPACE_BEGIN {
  ...
  protected:
    ...
    class PointerProxy {
      ...
      template <typename RefT> PointerProxy(RefT &&R) : R(std::forward<RefT>(R)) {}
  ...
  public:
    ...
    explicit pointer_iterator(WrappedIteratorT u) : pointer_iterator::iterator_adaptor_base(std::move(u)) {}
