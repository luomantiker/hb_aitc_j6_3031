...
colormap = {i: c for i, c in enumerate(colormap)}
colormap[255] = [0, 0, 0]
...
def get_default_parsing_labels(desc_id: str) -> List[Dict]:
    ...
    if desc_id == "us_8":
        ...
        labels = [
            ...
            {
                ParsingDescClassName: ["traffic_sign", "Traffic_Sign1"],
                ParsingDescColorMap: [220, 220, 0],
            },
            {
                ParsingDescClassName: ["traffic_light"],
            ...
            {
                ParsingDescClassName: ["lane_marking", "parking_line"],
                ParsingDescColorMap: [200, 200, 200],
            },
            {
                ParsingDescClassName: ["person"],
            ...
            {
                ParsingDescClassName: ["building", "column"],
                ParsingDescColorMap: [70, 70, 70],
            },
            {
                ParsingDescClassName: ["fence"],
            ...
            {
                ParsingDescClassName: ["Guide_Post"],
                ParsingDescColorMap: [139, 69, 19],
            },
            {
                ParsingDescClassName: ["Crosswalk_Line"],
            ...
            {
                ParsingDescClassName: ["BicycleSign"],
                ParsingDescColorMap: [128, 0, 192],
            },
            {
            ...
            {
                ParsingDescClassName: ["no_forward_marker"],
                ParsingDescColorMap: [0, 64, 64],
            },
            {
                ParsingDescClassName: ["parking_rod"],
                ParsingDescColorMap: [192, 0, 192],
            },
            {
                ParsingDescClassName: ["parking_lock"],
                ParsingDescColorMap: [128, 64, 64],
            },
            {
                ParsingDescClassName: ["traversable_obstruction"],
                ParsingDescColorMap: [0, 192, 64],
            },
            {
                ParsingDescClassName: ["untraversable_obstruction"],
                ParsingDescColorMap: [0, 128, 192],
            },
            {
                ParsingDescClassName: ["mask"],
                ParsingDescColorMap: [111, 134, 149],
            },
            {
                ParsingDescClassName: ["other"],
                ParsingDescColorMap: [96, 0, 192],
            },
        ]
    elif desc_id == "us_16":
        labels = [
...
def _get_image_fail_parsing_labels(desc_id: str) -> List[Dict]:
