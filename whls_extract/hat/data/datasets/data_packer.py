...
def _read_worker(
    packer: "Packer", data_idx: List, queue: multiprocessing.Queue
):
    """
    ...
    Args:
        packer: Instantiated packer.
        data_idx: Packing index.
        queue: Queue for packing data.
...
def _write_worker(packer: "Packer", queue: multiprocessing.Queue):
    """
...
class Packer(object):
    ...
    Args:
        uri: Path to the packing file.
        max_data_num: Num of data for packing.
        pack_type: The target pack type.
        ...
        queue_maxsize: Max size of queue.
        start_method: Start method for multiprocess.
        **kwargs: kwargs for pack type.
    """
    ...
    def __init__(
        ...
        pack_type: str,
        num_workers: int,
        queue_maxsize: Optional[int] = 1024,
    ...
    def _write_length(self, num: int):
        """
        Write max length to target format file.

        Args:
            num: Max length for packing data.
        """
        try:
