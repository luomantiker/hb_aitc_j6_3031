...
class RetinaNetHead(nn.Module):
    ...
    Args:
        ...
        int16_output (bool): If True, output int16, otherwise output int32.
            Default: True
    """  # noqa
    ...
    def forward_single(self, x):
        ...
        if self.dequant_output and self.training:
    ...
    def set_qconfig(self):
        ...
        if not self.int16_output:
            ...
            self.retina_cls.qconfig = out_int16_qconfig
            self.retina_reg.qconfig = out_int16_qconfig
