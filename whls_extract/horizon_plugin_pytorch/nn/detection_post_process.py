...
class DetectionPostProcess(torch.nn.Module):
    ...
    def __init__(
        ...
        # Params for decode.
        regression_scale: Tuple[float, float, float, float] = None,
        background_class_idx: int = None,
        size_threshold: float = None,
        image_size: Tuple[int, int] = None,
        pre_decode_top_n: int = None,
        post_decode_top_n: int = None,
        # Params for nms.
        iou_threshold: float = None,
        pre_nms_top_n: int = None,
        post_nms_top_n: int = None,
        nms_on_each_level: bool = False,
        mode: str = "normal",
    ):
