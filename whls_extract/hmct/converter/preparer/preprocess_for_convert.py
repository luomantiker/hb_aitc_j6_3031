...
from hmct.common import InputDictParser, add_model_output
from hmct.ir import DataType, OnnxModel, numpy_dtype_to_onnx_dtype
...
def set_pyop_shape(onnx_model: OnnxModel) -> OnnxModel:
    ...
    for onnx_node in pyop_nodes:
        ...
        output_shape_list = [
            [int(dim.strip()) for dim in shape.decode("utf8").split(",")]
