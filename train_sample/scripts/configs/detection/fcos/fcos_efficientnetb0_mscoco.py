...
quant_analysis_solver = dict(
    ...
    num_steps=1,
    baseline_model_convert_pipeline=qat_predictor["model_convert_pipeline"],
    # analysis_model_convert_pipeline=calibration_predictor[
    #    "model_convert_pipeline"
    # ],
    analysis_model=hbir_infer_model,
